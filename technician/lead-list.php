...
<body>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title"> Lead Lists </h3>
                            </div>
                            <div class="card-body">
    ...
    <script>
        ...
        const TodayleadData = [
            ...
            $Todaylead = "SELECT * FROM `leads` WHERE `lead_for_company` = '$Company' AND `lead_for_branch` = '$Branch' AND `assign_technician` = '$username' AND `lead_type`='Completed' ORDER BY `id` DESC";
