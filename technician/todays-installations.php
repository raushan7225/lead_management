...
<body>
    ...
    <script>
        ...
        const TodayleadData = [
            ...
            $Todaylead = "SELECT * FROM `leads` WHERE `lead_for_company` = '$Company' AND `lead_for_branch` = '$Branch' AND `assign_technician` = '$username' AND `lead_delivery_date` = '$date' AND `lead_instalation_date` = '0000-00-00' AND `lead_type`='Completed' AND `lead_instalation_aggreement`='' ORDER BY `id` DESC";
