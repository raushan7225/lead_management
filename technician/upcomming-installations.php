...
$sql = "SELECT * FROM `leads` WHERE `lead_for_company` = '$Company'  AND `lead_for_branch` = '$Branch'  AND `assign_technician` = '$username'  AND `lead_delivery_date` > '$currentDate'  AND `lead_delivery_date` <= '$futureDate' AND `lead_instalation_aggreement` = ''  AND `lead_type` = 'Completed'  AND `lead_customer_status` = '1'  ORDER BY `lead_delivery_date`, `id` DESC";
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Upcoming Installations</h3>
                            </div>
                            <div class="card-body">
                            ...
                            <div class="row gap-2">
                                <div class="col-5">
                                    <form action="#" method="post" enctype="multipart/form-data" data-bs-toggle="tooltip" data-bs-custom-class="primary-tooltip" data-bs-title="Edit followups">
                                        ...
                                        <button type="submit" name="edit_lead" value="<?php echo $lead['id']; ?>" class="btn btn-soft-primary btn-sm">
