                                            ...
                                            <div class="col-lg-12">
                                                <div id="services-container">
                                                    ...
                                                    foreach ($myServiceLead as $key => $serviceLead) {
                                                        ...
                                                        <input type="text" name="lead_product_remark[]" class="form-control" style="height: 38px;" placeholder="Remarks" value="' . $serviceLead['lead_product_remark'] . '">
...
<?php
    ...
    if (isset($_POST['update_lead'])) {
        ...
        $lead_delivery_subject = $_POST['lead_delivery_subject'];
        $lead_delivery_address = $_POST['lead_delivery_address'];
        $lead_sub_total = $_POST['lead_sub_total'];
        $lead_other_charges = $_POST['lead_other_charges'];
        $lead_grand_total = $_POST['lead_grand_total'];
        ...
        #################### Troubleshoot #####################
        // echo $lead_customer_name;
        // echo $lead_customer_contact;
        // echo $lead_for_branch;
        // echo $lead_product_departure_date;
        // echo $lead_delivery_subject;
        // echo $lead_delivery_address;
        // echo $product_services_name;
        // echo $product_regular_prices;
        // echo $product_quantities;
        // echo $product_offer_prices;
        // echo $product_remarks;
        // echo $lead_sub_total;
        // echo $lead_other_charges;
        ...
        if ($ApplyUpdatedLead) {
            ...
            ################# Push activity ################
            $activity_id = $guid;
            $activity_content = "Quotation of customer " . $lead_customer_name . " has been updated by staff " . $username . " of " . $Branch . " branch.";
            $activity_type = 'Alert';
