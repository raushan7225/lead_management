...
######################### All Lead #########################
$lead_list = "SELECT * FROM `leads` WHERE `lead_for_company`='$Company' AND `lead_for_branch`='$Branch' AND `lead_assign_to` = '$username' AND `lead_updatedby`='$username' ORDER BY `id` DESC";
