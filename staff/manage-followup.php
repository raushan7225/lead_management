...
if (isset($_GET['id'])) {
     ...
     if ($Role == 'Admin') {
          $Employee_list = "SELECT * FROM `employees` WHERE `employee_of_company`='$Company' AND `employee_user_role` = 'Staff' AND `employee_status` = '1'";
...
?>
     ...
     <body>
                                        ...
                                        <div class="card">
                                             ...
                                             <div class="card-body">
                                                  <div class="row">
                                                       ...
                                                       <!-- Delivery Date (Hidden by default) -->
                                                       <div class="col-lg-3" style="display: none;" id="delivery_date">
                                                            <div class="mb-3">
                                                                 ...
                                                                 <input type="date" id="lead_delivery_date" name="lead_delivery_date" class="form-control" placeholder="Delivery Date" value="<?php echo $lead_delivery_date; ?>">
                                                            </div>
                                                       </div>
                                                       ...
                                                       <div class="col-lg-3">
                                                            <div class="mb-3">
                                                                 ...
                                                                 <input type="date" id="lead_next_followup_date" name="lead_next_followup_date" class="form-control" placeholder="Next Followup Date" required value="<?php echo $lead_next_followup_date; ?>">
                                                            </div>
                                                       </div>
                                                            ...
                                                            <div class="mb-3">
                                                                 ...
                                                                 <select name="lead_reference" id="lead_reference" class="form-control" data-choices>
                                                                      ...
                                                                      <?php foreach ($reference_name as $lead_reference) { ?>
                                                                           <option value="<?php echo $lead_reference['reference_name']; ?>" <?php echo ($lead_reference['reference_name'] == $lead_reference['reference_name']) ? 'selected' : ''; ?>><?php echo $lead_reference['reference_name']; ?></option>
                                                                      <?php }
                                                                      ?>
                                                                 </select>
                                                            </div>
                                                       ...
                                                       <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                 ...
                                                                 <textarea type="text" id="lead_remark" name="lead_remark" rows="1" class="form-control" placeholder="Remarks"><?php echo $lead_remark; ?></textarea>
                                                            </div>
                                                       </div>
                                                       ...
                                                       <div class="col-lg-3">
                                                            <div class="mb-3">
                                                                 <label for="lead_assign_to" class="form-label">Lead transfer to</label>
          ...
          <!-- Lead Status if place order / cancel / completed -->
          <script>
               function showDeliveryDate(leadType) {
                    ...
                    // Disable/Enable Next Followup Date based on lead type
                    if (leadType === "Cancel" || leadType === "Completed") {
                         nextFollowupDateInput.disabled = true; // Disable the input field
                    } else {
                         nextFollowupDateInput.disabled = false; // Enable the input field
                    }

                    // Show/Hide Delivery Date based on lead type
                    if (leadType === "Completed") {
                         deliveryDateSection.style.display = "block"; // Show the delivery date input
                    } else {
                         deliveryDateSection.style.display = "none"; // Hide the delivery date input
                    }
               }
...
<?php
     ...
     if (isset($_POST['update_lead'])) {
          ...
          if (mysqli_query($conn, $updateLead)) {
