...
$lead_list = "SELECT * FROM `leads` WHERE `lead_for_company`='$Company' AND `lead_for_branch`='$Branch' AND `lead_assign_to` = '$username' AND `lead_updatedby` = '$username' AND `lead_type` = 'Completed' AND `lead_customer_status`='1' ORDER BY `id` DESC";
