...
############### Fetch and process permissions for Staff ###################
$FetchPermission = "SELECT `permission_options`, `permission_assign_to` FROM `permissions` WHERE `permission_status` = '1' AND `permission_assign_to` LIKE '%Staff%'";
...
if ($FetchPermissionResult->num_rows > 0) {
    while ($PermissionRow = $FetchPermissionResult->fetch_assoc()) {
        ...
        if (in_array('Staff', $assigned_roles)) {
...
<div class="main-nav">
    ...
    <div class="scrollbar" data-simplebar>
        <ul class="navbar-nav" id="navbar-nav">
            ...
            <!-- User Control Menu (typically limited for Staff) -->
            <?php if ($User_Control): ?>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="sidebarLeadsControl">
                        <ul class="nav sub-navbar-nav">
                            ...
                            <li class="sub-nav-item">
                                <a class="sub-nav-link" href="leads-add.php">Add Lead</a>
                            </li>
                            <li class="sub-nav-item">
                                <a class="sub-nav-link" href="lead-transfer.php">Lead Transfer</a>
                            </li>
                        </ul>
                    </div>
                </li>
