...
if (isset($_POST['publish'])) {
     ...
     $updateStatusQuery = "UPDATE `references` SET `reference_status` = '$new_status' WHERE `id` = '$reference_id'";
...
if (isset($_POST['delete_reference'])) {
     ...
     $deletereferenceQuery = "DELETE FROM `references` WHERE `id` = '$reference_id'";
     ...
     if ($checkDelete) {
          ################# Push activity ################
          $activity_id = $guid;
          $activity_content = "The reference " . $reference_name . " has been removed by " . $Role . ".";
          $activity_type = 'Alert';
          $activity_company = "";
          $activity_branch = "";
               ...
               if ($counterValue <= mysqli_num_rows($reference_list_result)) {
                    while ($reference = $reference_list_result->fetch_assoc()) {
                         ...
                         $reference_name = $reference['reference_name']; ?>[
                              ...
                              "<?php echo $reference['reference_id']; ?>",
                              "<?php echo $reference['reference_name']; ?>",
                              "<?php echo $reference['reference_contact']; ?>",
                              "<?php echo $reference['reference_for_company']; ?>",
