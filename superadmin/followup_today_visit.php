...
if (isset($_GET["lead_for_company"])) {
    ...
    $lead_list = "SELECT * FROM `leads` WHERE `lead_for_company` = '$lead_for_company' AND `lead_next_followup_date` = '$date' AND `lead_assign_to`!='' AND `lead_updatedby`!='' AND `lead_status` = 'Client Visit' ORDER BY `id` DESC";
...
if (isset($_POST['search_lead'])) {
    ...
    if (!empty($urlParams)) {
        ...
        echo "<script>window.location.href='followup_today_visit.php?$queryString';</script>";
        exit;
    }
}
######################## Apply filter and redirect #########################
...
$date = date("Y-m-d");
$lead_list = "SELECT * FROM `leads` WHERE `lead_next_followup_date` = '$date' AND `lead_assign_to`!='' AND `lead_updatedby`!='' AND `lead_status` = 'Client Visit'";
$lead_for_branch    = $_GET['lead_for_branch'] ?? '';
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Filter Followups Visit</h4>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="row justify-content-between g-2">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <a href="followup_today_visit.php" class="btn btn-primary w-100">Reset</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        const leadData = [
            ...
            if ($counterValue <= $lead_list_result->num_rows) {
                while ($lead = $lead_list_result->fetch_assoc()) { ?>[
                        ...
                        gridjs.html(`<?php echo $lead['lead_next_followup_time']; ?>`),
