...
if ($lead_for_branch) {
    ...
    if ($FindCompanyResult && mysqli_num_rows($FindCompanyResult) > 0) {
        ...
        if (isset($_POST['transfer_lead'])) {
            ...
            $error_transfer = "Leads Transfer Successfully";

            ################# Push activity ################
            $activity_id = $guid;
            $activity_content = "Some leads transfer to staff " .  $lead_assign_to . " has been transferred by " . $Role . ".";
            $activity_type = 'Alert';
            $activity_company = "";
            $activity_branch = "";
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 mb-3">
                                                <small><strong class="text-warning">Note:</strong> Select branch then show leads and staff list. Then you can transfer leads to any employee.</small>
                                            </div>
                                            <div class="col-lg-12">
