...
if (isset($_GET['id'])) {
     $id = $_GET['id'];
     ################# Fetch all products #################
     $show_product = "SELECT * FROM `products` WHERE `id` = '$id'";
                                                                           ...
                                                                           <select class="form-control" id="product_for_company" name="product_for_company" data-choices required>
                                                                                ...
                                                                                <?php foreach ($company_name as $mycompany) { ?>
                                                                                     <option value="<?php echo $mycompany['company_name']; ?>"
                                                                                          <?php echo ($mycompany['company_name'] == $productDatas['product_for_company']) ? 'selected' : ''; ?>>
...
<?php
     ...
     if (isset($_POST['update_product'])) {
          ...
          $UpdateProduct  = "UPDATE `products` SET 
               ...
               `product_for_company`='$product_for_company',
          ...
          if ($checkProduct) {
               ################# Push activity ################
               $activity_id = $guid;
               $activity_content = "The product " . $product_name . " has been updated by " . $Role . ".";
               $activity_type = 'Alert';
               $activity_company = "";
               $activity_branch = "";
