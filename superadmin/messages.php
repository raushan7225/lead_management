...
$UsersList = [];
$CollectUsersSQL = "SELECT `employee_username`, `employee_name`, `profile_pic` FROM `employees` WHERE `employee_username` != '$username' AND `employee_status` = '1' ORDER BY `employee_name` ASC";
