...
if (isset($_GET['id'])) {
     ...
     if (mysqli_num_rows($checkLeadsQuery) > 0) {
          while ($lead = mysqli_fetch_assoc($checkLeadsQuery)) {
               ...
               $reference_list = "SELECT * FROM `references` WHERE `reference_for_company`='$lead_for_company' AND `reference_status` = '1'";
                              ...
                              <div class="col-lg-12">
                                   <div class="card">
                                        <div class="card-header">
                                             <h4 class="card-title">View Followup Details</h4>
                                        </div>

                                        <div class="card-body">
                                             <div class="row">

                                                  <!-- Lead Assined To Branch -->
                                                  <div class="col-lg-3">
                                                       <div class="mb-3">
                                                            <label for="lead_assined_branch" class="form-label text-dark">Assigned to Branch </label>
                                                            <input type="text" id="lead_assined_branch" class="form-control" value="<?php echo $lead_for_branch; ?>" disabled>
                                                       </div>
                                                  </div>
                                                       ...
                                                       <div class="mb-3">
                                                            ...
                                                            <select class="form-control" id="lead_for_branch" name="lead_for_branch" data-choices onchange="this.form.submit()" required>
                                                                 ...
                                                                 <!?php foreach ($branchename as $mybranch) { ?>
                                                                      <option value="<!?php echo $mybranch['branch_name']; ?>" <!?php echo (isset($_POST['lead_for_branch']) && $_POST['lead_for_branch'] == $mybranch['branch_name']) ? 'selected' : ''; ?>><!?php echo $mybranch['branch_name']; ?></option>
                                                                 <!?php } ?>
                                                            </select>
                                                       </div>
                                                  </div> -->
                                                  ...
                                                  <div class="col-lg-3">
                                                       <div class="mb-3">
                                                            ...
                                                            <input type="tel" id="lead_customer_contact" name="lead_customer_contact" class="form-control" placeholder="Contact Number" minlength="10" maxlength="10" pattern="[0-9]{10}" required value="<?php echo $lead_customer_contact; ?>" disabled>
                                                       </div>
                                                  </div>
                                                  ...
                                                  <div class="col-lg-3">
                                                       <div class="mb-3">
                                                            <label for="lead_whatsapp" class="form-label text-dark">
                                                                 <input type="checkbox" name="sameascontact" id="sameascontact" disabled> Whatsapp No. same as Contact
                                                            </label>
                                                  ...
                                                  <div class="col-lg-3">
                                                       <div class="mb-3">
                                                            ...
                                                            <select name="lead_state" id="lead_state" class="form-control" data-choices disabled>
                                                  ...
                                                  <div class="col-lg-3">
                                                       <div class="mb-3">
                                                            ...
                                                            <select name="lead_customer_type" id="lead_customer_type" class="form-control" data-choices disabled>
                                                  ...
                                                  <div class="col-lg-3">
                                                       <div class="mb-3">
                                                            ...
                                                            <input type="tel" id="lead_alternate_contact" name="lead_alternate_contact" class="form-control" placeholder="Phone No." value="<?php echo $lead_alternate_contact; ?>" minlength="10" maxlength="10" maxlength="10" disabled>
                                                       </div>
                                                  </div>
                                                  ...
                                                  <div class="col-lg-12">
                                                       ...
                                                       <textarea type="text" id="lead_delivery_address" name="lead_delivery_address" rows="1" class="form-control" placeholder="Address" disabled><?php echo $lead_delivery_address; ?></textarea>
                                                  </div>
                                             </div>
                                        </div>
                                   </div>
                                                       ...
                                                       <div id="services-container">
                                                            ...
                                                            foreach ($myServiceLead as $key => $SearviceLead) {
                                                                 echo '<div class="col-lg-12">
                                                                      ...
                                                                      <select id="lead_product_services' . $key . '" name="lead_product_services[]" class="form-control" data-choices disabled>
                                             ...
                                             <div class="row">
                                                  ...
                                                  <div class="col-lg-3">
                                                       <div class="mb-3">
                                                            ...
                                                            <select class="form-control" name="lead_type" id="lead_type" data-choices required onchange="showDeliveryDate(this.value)" disabled>
                                                  ...
                                                  <div class="col-lg-3" id="AssignTechnician" style="display: none;">
                                                       <div class="mb-3">
                                                            ...
                                                            <select name="assign_technician" id="assign_technician" class="form-control" data-choices disabled>
                                                  ...
                                                  <div id="deliveryDate" class="col-lg-3" style="display: none;">
                                                       <div class="mb-3">
                                                            ...
                                                            <input type="date" id="basic-datepicker1" name="lead_delivery_date" class="form-control" placeholder="Delivery Date" value="<?php echo $lead_delivery_date; ?>" required disabled>
                                                       </div>
                                                  </div>
                                                  ...
                                                  <div class="col-lg-3">
                                                       <div class="mb-3">
                                                            ...
                                                            <input type="date" id="basic-datepicker2" name="lead_next_followup_date" class="form-control" placeholder="Next Followup Date" value="<?php echo $lead_next_followup_date; ?>" required disabled>
                                                       </div>
                                                  </div>
                                                  ...
                                                  <div class="col-lg-3">
                                                       <div class="mb-3">
                                                            ...
                                                            <input type="time" id="basic-timepicker" name="lead_next_followup_time" class="form-control" placeholder="Next Followup Time" value="<?php echo $lead_next_followup_time; ?>" required disabled>
                                                       </div>
                                                  </div>
                                                  ...
                                                  <div class="col-lg-3">
                                                       <div class="mb-3">
                                                            ...
                                                            <select class="form-control" name="lead_status" id="lead_status" data-choices required disabled>
                                                  ...
                                                  <div class="col-lg-3">
                                                       <div class="mb-3">
                                                            ...
                                                            <select name="lead_reference" id="lead_reference" class="form-control" data-choices disabled>
                                                  ...
                                                  <div class="col-lg-3">
                                                       <div class="mb-3">
                                                            ...
                                                            <select class="form-control" id="lead_assign_to" name="lead_assign_to" data-choices disabled>
                                                  ...
                                                  <div class="col-lg-12">
                                                       <div class="mb-3">
                                                            ...
                                                            <textarea type="text" id="lead_remark" name="lead_remark" rows="3" class="form-control" placeholder="Remarks" disabled><?php echo $lead_remark; ?></textarea>
                                                       </div>
                                                  </div>
