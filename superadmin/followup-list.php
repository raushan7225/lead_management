            ...
            if ($counterValue <= $lead_list_result->num_rows) {
                while ($lead = $lead_list_result->fetch_assoc()) { ?>[
                        ...
                        gridjs.html(`
                            <div class="row gap-2">
                                <div class="col-5">
                                    <a href="followup-edit.php?id=<?php echo $lead['id']; ?>" class="btn btn-soft-primary btn-sm" data-bs-toggle="tooltip" data-bs-custom-class="primary-tooltip" data-bs-title="Edit followups">
