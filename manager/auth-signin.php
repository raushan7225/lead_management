                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 py-lg-4-3">
                        <div class="d-flex flex-column justify-content-center full-height p-2">
                            ...
                            <p class="text-muted text-center mb-3">Login to access your Manager Dashboard</p>
                            ...
                            <div class="mb-3">
                                ...
                                <form action="" method="POST" class="authentication-form" id="loginForm">
                                    ...
                                    <div class="mb-3 d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="#" class="text-decoration-none small" onclick="alert('Contact superadmin to reset password'); return false;">
                                            Forgot Password?
                                        </a>
                                    </div>
