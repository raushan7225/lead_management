                                   ...
                                   <div class="col-lg-12">
                                        ...
                                        <div class="p-3 bg-light mb-3 rounded">
                                             <div class="row justify-content-end g-2">
                                                  <div class="col-lg-2">
                                                       <a href="lead-list.php" class="btn btn-primary w-100">Back to Home</a>
                                                  </div>
                                             </div>
                                        </div>
                                   </div>
...
<?php
     ...
     if (isset($_POST['update_lead'])) {
          ...
          ################# Push Notification ################
          $notify_id = $guid;
          $notification = "The followup of lead / customer [" . $lead_customer_name . "] attampted by " . $Role . " of " . $Branch . " branch.";
          $notify_type = 'Alert';
