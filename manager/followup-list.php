...
#################### Fetch Lead ######################
$lead_list_query = "SELECT * FROM `leads` WHERE `lead_for_company` = '$Company' AND `lead_for_branch` = '$Branch' AND `lead_assign_to` != '' AND `lead_updatedby` != '' ORDER BY `id` DESC";
                ...
                while ($lead = $lead_list_result->fetch_assoc()) { ?>[
                        ...
                        gridjs.html(`
                            <div class="row gap-2">
                                ...
                                <?php } else { ?>
                                    <a href="#" target="_blank" class="btn btn-soft-success btn-sm" data-bs-toggle="tooltip" data-bs-custom-class="success-tooltip" data-bs-title="Call Now">
                                        <iconify-icon icon="solar:outgoing-call-line-duotone" class="align-middle fs-18"></iconify-icon>
                                    </a>
                                <?php } ?>
                                 </div>
