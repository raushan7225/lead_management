...
if (isset($_POST["add_reference"])) {
     ...
     ################# Push activity ################
     $activity_id = $guid;
     $activity_content = "Reference " . $reference_name . " has been added by manager " . $username . " of " . $Branch . " branch.";
     $activity_type = 'Alert';
                    ...
                    <form action="#" method="POST" enctype="multipart/form-data">
                         ...
                         <div class="p-3 bg-light mb-3 rounded">
                              <div class="row justify-content-end g-2">
                                   <div class="col-lg-2">
                                        <button type="submit" name="add_reference" class="btn btn-outline-secondary w-100">Add Reference</button>
                                   </div>
                                   <div class="col-lg-2">
