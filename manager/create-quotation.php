...
if (isset($_GET['id'])) {
    ...
    if (mysqli_num_rows($checkLeadsQuery) > 0) {
        while ($lead = mysqli_fetch_assoc($checkLeadsQuery)) {
            ...
            $assigned_technician = $lead['assign_technician'];
                                            ...
                                            <div class="col-lg-3">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="assign_technician" id="assign_technician" class="form-control" data-choices>
                                                        ...
                                                        <?php foreach ($Technicians as $Technassigns) { ?>
                                                            <option value="<?php echo $Technassigns['employee_username']; ?>" <?php echo ($Technassigns['employee_username'] == $assigned_technician) ? 'selected' : ''; ?>>
                                                                <?php echo $Technassigns['employee_name']; ?>
                                                            </option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
...
<?php
    ...
    if (isset($_POST['update_lead'])) {
        ...
        if ($applyUpdateLeadQuery) {
            ################# Push activity ################
            $activity_id = $guid;
            $activity_content = "Quotation of customer " . $lead_customer_name . "has been updated by manager " . $username . " of " . $Branch . " branch.";
            $activity_type = 'Alert';
