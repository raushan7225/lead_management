...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['delete_lead']) && $mylead_id) {
        $query = "DELETE FROM `leads` WHERE `id` = '$mylead_id'";
        $lead_customer_name = $_POST['lead_customer_name'];
        $aplyquery = $conn->query($query);
    ...
    } elseif (isset($_POST['edit_lead']) && $mylead_id) {
...
######### Fetch employees according to branch #########
$Employeename = [];
...
$lead_filter_query = "SELECT * FROM `leads` WHERE `lead_for_company`='$Company' AND `lead_assign_to`!='' AND `lead_updatedby`!='' AND `lead_customer_status` = '1'";
...
if (isset($_POST['search_lead'])) {
    ...
    if (!empty($urlParams)) {
        ...
        echo "<script>window.location.href='followup-list.php?$queryString';</script>";
        exit;
    }
}
############ Apply Filter On Lead List ##############
...
$lead_list_query = "SELECT * FROM `leads` WHERE `lead_for_company`='$Company' AND `lead_assign_to`!='' AND `lead_updatedby`!='' AND `lead_customer_status` = '1'";
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="row justify-content-between g-2">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <a href="followup-list.php" class="btn btn-primary w-100">Reset</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="d-flex card-header justify-content-between align-items-center">
                                <h4 class="card-title">All Followup List </h4>
