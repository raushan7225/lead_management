...
if (isset($_GET['id'])) {
     ...
     $Employee_list = "SELECT * FROM `employees` WHERE `employee_of_company`='$Company' AND `employee_of_branch`='$lead_for_branch' AND `employee_user_role` NOT IN ('Admin', 'Super Admin') AND `employee_status` = '1' ORDER BY `employee_name` ASC";
                                   ...
                                   <div class="card">
                                        ...
                                        <div class="card-body">
                                             <div class="row">
                                                  ...
                                                  <div class="col-lg-3">
                                                       <div class="mb-3">
                                                            <label for="lead_assined_branch" class="form-label text-dark">Assined Branch </label>
                                                            <input type="hidden" id="lead_assined_branch" name="lead_for_branch" class="form-control" value="<?php echo $lead_for_branch; ?>">
                                                            <input type="text" class="form-control" value="<?php echo $lead_for_branch; ?>" disabled>
                                                       </div>
                                                  </div>
                                                  ...
                                                  <div class="col-lg-4">
                                                       <div class="mb-3">
                                                            ...
                                                            <input type="tel" id="lead_alternate_contact" name="lead_alternate_contact" class="form-control" placeholder="Phone No." value="<?php echo $lead_alternate_contact; ?>" minlength="10" maxlength="10" maxlength="10" value="<?php echo $lead_alternate_contact; ?>" disabled>
                                                       </div>
                                                  </div>
                                                  ...
                                                  <div class="col-lg-12">
                                                       ...
                                                       <textarea type="text" id="lead_delivery_address" name="lead_delivery_address" rows="2" class="form-control" placeholder="Address" disabled><?php echo $lead_delivery_address; ?></textarea>
                                                  </div>
                                             </div>
                                        </div>
                                   </div>
                                             ...
                                             <div class="row">
                                                  ...
                                                  <div id="deliveryDate" class="col-lg-3" style="display: none;">
                                                       <div class="mb-3">
                                                            ...
                                                            <input type="date" id="basic-datepicker1" name="lead_delivery_date" class="form-control" placeholder="Delivery Date" value="<?php echo $lead_delivery_date; ?>" disabled>
                                                       </div>
                                                  </div>
                                                  ...
                                                  <div class="col-lg-6">
                                                       <div class="mb-2">
                                                            ...
                                                            <textarea id="lead_remark" class="form-control" name="lead_remark" rows="1" placeholder="Enter your remark here..." disabled><?php echo $lead_remark; ?></textarea>
                                                       </div>
                                                  </div>
