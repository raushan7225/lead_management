...
if (isset($_GET['id'])) {
     ...
     $branch_list = "SELECT * FROM `branches` WHERE `branch_of_company`='$Company' AND `branch_status` = '1' ORDER BY `branch_name` ASC";
     ...
     $state_list = "SELECT * FROM `states` WHERE `state_status` = '1' ORDER BY `state_name` ASC";
     ...
     $products_list = "SELECT * FROM `products` WHERE `product_for_company`='$Company' AND `status` = '1' ORDER BY `product_name` ASC";
     ...
     $reference_list = "SELECT * FROM `references` WHERE `reference_for_company`='$Company' AND `reference_status` = '1' ORDER BY `reference_name` ASC";
     ...
     ################### Show Leads Details ########################
     $checkLeads = "SELECT * FROM `leads` WHERE `lead_for_company`='$Company' AND `lead_customer_status` = '1' AND `id` = '$id' ORDER BY `id` DESC";
     ...
     if (mysqli_num_rows($checkLeadsQuery) > 0) {
          while ($lead = mysqli_fetch_assoc($checkLeadsQuery)) {
               ...
               $Employees = [];
               $Technicians = [];
               $Employee_list = "SELECT * FROM `employees` WHERE `employee_of_company`='$Company' AND `employee_of_branch`='$lead_for_branch' AND `employee_user_role` NOT IN ('Super Admin') AND `employee_status` = '1'";
                                                  ...
                                                  <div class="row">
                                                       ...
                                                       <div class="col-lg-3">
                                                            <div class="mb-3">
                                                                 ...
                                                                 <input type="hidden" name="lead_for_branch" class="form-control" value="<?php echo $lead_for_branch; ?>">
                                                                 <input type="text" id="lead_assined_branch" name="lead_for_branch" class="form-control" value="<?php echo $lead_for_branch; ?>" disabled>
                                                            </div>
                                                       </div>
                                                  ...
                                                  <div class="row">
                                                       ...
                                                       <div class="col-lg-6">
                                                            <div class="mb-2">
                                                                 ...
                                                                 <textarea id="lead_remark" class="form-control" name="lead_remark" rows="1" placeholder="Enter your remark here with (',') for multile remarks...."><?php echo $lead_remark; ?></textarea>
                                                            </div>
                                                       </div>
...
<?php
     ...
     if (isset($_POST['update_lead'])) {
          ...
          if ($updateLeadQuery) {
               ################# Push activity ################
               $activity_id = $guid;
               $activity_content = "Followup of customer " . $lead_customer_name . " has been followed up by admin " . $username . " of " . $Company . " company.";
               $activity_type = 'Alert';
