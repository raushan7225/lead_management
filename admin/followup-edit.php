                                                  ...
                                                  <div class="row">
                                                       ...
                                                       <div class="col-lg-6">
                                                            <div class="mb-2">
                                                                 ...
                                                                 <textarea id="lead_remark" class="form-control" name="lead_remark" rows="1" placeholder="Enter your remark here..."><?php echo $lead_remark; ?></textarea>
                                                            </div>
                                                       </div>
