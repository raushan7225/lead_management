...
if (isset($_POST['publish'])) {
    ...
    $updateStatusQuery = "UPDATE `leads` SET `lead_customer_status` = '$new_status', `lead_updatedby` = '$username' WHERE `lead_for_company` = '$Company' AND `id` = '$customer_id'";
...
$branchename = [];
$branch_list_result = $conn->query("SELECT * FROM `branches` WHERE `branch_of_company`='$Company' AND `branch_status` = '1' ORDER BY `branch_name` ASC");
...
if (isset($_GET['lead_for_branch'])) {
    ...
    $employee_list_result = $conn->query("SELECT * FROM `employees` WHERE `employee_of_company`='$Company' AND `employee_of_branch`='$employee_of_branch' AND `employee_user_role`='Staff' AND `employee_status`='1' ORDER BY `employee_name` ASC");
} else {
    $employee_list_result = $conn->query("SELECT * FROM `employees` WHERE `employee_of_company`='$Company' AND `employee_user_role`='Staff' AND `employee_status`='1' ORDER BY `employee_name` ASC");
}
...
$lead_filter_query = "SELECT * FROM `leads` WHERE `lead_for_company`='$Company'";
...
if (isset($_POST['search_lead'])) {
    ...
    if (!empty($urlParams)) {
        ...
        echo "<script>window.location.href='customers-list.php?$queryString';</script>";
        exit;
    }
}
############ Apply Filter On Lead List ##############
...
######### Fetch final filtered lead list for display #########
$lead_list_query = "SELECT * FROM `leads` WHERE `lead_for_company`='$Company'";
