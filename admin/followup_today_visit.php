...
$lead_filter_query = "SELECT * FROM `leads` WHERE `lead_for_company` = '$Company' AND `lead_next_followup_date` = '$date' AND `lead_status` = 'Client Visit' AND `lead_assign_to` != '' AND `lead_updatedby` != '' AND `lead_customer_status` = '1'";
...
$lead_list_query = "SELECT * FROM `leads` WHERE `lead_for_company` = '$Company' AND `lead_next_followup_date` = '$date' AND `lead_status` = 'Client Visit' AND `lead_assign_to` != '' AND `lead_updatedby` != '' AND `lead_customer_status` = '1'";
