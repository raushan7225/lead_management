...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['manage_followup'])) {
        ...
        $deleteLeadQuery = "DELETE FROM `leads` WHERE `lead_for_company`='$Company' AND `id` = $mylead_id";
...
$lead_filter_query = "SELECT * FROM `leads` WHERE `lead_for_company`='$Company' AND `lead_customer_status` = '1' ";
######### Fetch all leads from the database #########
...
######### Begin building the filtered query #########
$lead_filter_query = "SELECT * FROM `leads` WHERE `lead_for_company`='$Company' AND `lead_customer_status` = '1' ";
...
######### End building the filtered query #########
...
$lead_list_query = $lead_filter_query . " ORDER BY `id` DESC";
