...
if (isset($_POST['add_employee'])) {
    ...
    if (mysqli_num_rows($userLimitResult) > 0) {
        ...
        if ($userLimit !== "Unlimited" && $currentUsers >= $userLimit) {
            $error_user_add = "Error: User limit reached for this company! Please try another contact.";
        }
    }
    ...
    if (empty($error_user_add)) {
        ...
        $checkContact = "SELECT * FROM `employees` WHERE `employee_contact` = '$employee_contact' OR `employee_username`='$employee_username'";
        $checkContactQuery = mysqli_query($conn, $checkContact);

        if (mysqli_num_rows($checkContactQuery) > 0) {
            // If either contact or username exists, set the appropriate error message
            ...
            // If no contact or username exists, proceed to insert the new employee
            ...
            if ($addEmployeeQuery) {
                ...
                ################# Push activity ################
                $activity_id = $guid;
                $activity_content = "New employee " . $employee_name . " has been added by admin " . $username . " of " . $Company . " company.";
                $activity_type = 'Alert';
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    <label for="employee_name" class="form-label text-dark">Personal Employee Name</label>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <textarea type="text" id="employee_address" name="employee_address" class="form-control" rows="6" placeholder="Address"></textarea>
                                            </div>
